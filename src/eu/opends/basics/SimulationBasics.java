...
public class SimulationBasics extends SimpleApplication 
{
     ...
     */
    private void setAnisotropy(int anisotropyLevel) {
        AssetEventListener asl = new AssetEventListener() {         
            ...
            public void assetRequested(AssetKey key) {
                if (key.getExtension().equals("png") || key.getExtension().equals("jpg") || key.getExtension().equals("dds")) {
                    ...
                    tkey.setAnisotropy(anisotropyLevel);
                }
            }

			@Override
			public void assetDependencyNotFound(AssetKey arg0, AssetKey arg1) {
				// TODO Auto-generated method stub
				
			}

			@Override
			public void assetLoaded(AssetKey arg0) {
				// TODO Auto-generated method stub
